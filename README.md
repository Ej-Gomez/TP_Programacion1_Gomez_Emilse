...
# Valida los nombres de los participantes al menos 3 caracteres y solo letras y espacios.
...
# Cargar los nombres de 5 participantes. (Punto 1)
...
# ESPECIFICA 
# Muestra el ingreso de las puntuaciones de los jurados para cada participante. (Punto 2)
...
#ESPECIFICA
# Muestra los resultados: nombre, puntajes individuales y promedio general. (Punto 3)
def mostrar_resultados(participantes, puntuaciones):
    ...
    while i < len(participantes):
        ...
        print(f"{nombre:<20} Puntajes: [{puntajes_texto}]  Promedio: {promedio:.2f}") #Une todos los strings generados con , como separador.
        i += 1

#Mostrar participantes con promedio menor a 4 y a 8. Con mensaje de error si no hay ninguno. (Punto 4-5)
...
#Promedio de cada jurado. (Punto 6)
...
#Jurado más estricto(menos puntaje) y más generoso(mas puntaje). (Punto 7 y 8)
...
#Participantes con puntuaciones iguales(total o promedio). Si no hay mostrar msj de ERROR. (Punto 9)
...
#Buscar participante por nombre, y sus datos. Si no existe Mostrar msj de ERROR. (Punto 10)
...
puntuaciones = ingresar_puntuaciones(participantes)
mostrar_resultados(participantes, puntuaciones)
mostrar_promedios_menores(participantes, puntuaciones, 4)
mostrar_promedios_menores(participantes, puntuaciones, 8)
mostrar_promedio_por_jurado(puntuaciones)
mostrar_jurado_extremos(puntuaciones)
mostrar_puntuaciones_iguales(participantes, puntuaciones) 
buscar_participante(participantes, puntuaciones)
top_3_participantes(participantes, puntuaciones)
mostrar_orden_alfabetico(participantes, puntuaciones)
mostrar_ganador(participantes, puntuaciones)
desempatar(participantes, puntuaciones)
